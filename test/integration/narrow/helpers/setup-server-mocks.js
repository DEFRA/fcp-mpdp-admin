...
vi.mock('../../../../src/auth/federated-credentials.js', () => ({
  getCachedFederatedToken: vi.fn().mockResolvedValue('mock-federated-token'),
  getClientCredentialParams: vi.fn().mockResolvedValue({ client_secret: 'mock-client-secret' })
}))
